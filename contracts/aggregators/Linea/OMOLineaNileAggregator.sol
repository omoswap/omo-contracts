...
import "../interfaces/INileSwapRouter.sol";
import "@openzeppelin/contracts/token/ERC20/IERC20.sol";
import "@openzeppelin/contracts/token/ERC20/utils/SafeERC20.sol";

contract OMOLineaNileAggregator is Ownable {
    ...
    address public router = 0xAAAE99091Fbb28D400029052821653C1C752483B;
    ...
    function exactInput(
        INileSwapRouter.ExactInputParams memory params,
        bool unwrapETH
    ) external payable {
    ...
    function exactInputCrossChain(
        INileSwapRouter.ExactInputParams calldata params,
    ...
    function _swap(
        ...
        INileSwapRouter(router).exactInput(params);
