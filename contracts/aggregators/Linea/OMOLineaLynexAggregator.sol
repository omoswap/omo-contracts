...
import "../interfaces/ILynexRouter.sol";
import "@openzeppelin/contracts/token/ERC20/IERC20.sol";
import "@openzeppelin/contracts/token/ERC20/utils/SafeERC20.sol";

contract OMOLineaLynexAggregator is Ownable {
    ...
    address public router = 0x610D2f07b7EdC67565160F587F37636194C34E74;
    ...
    function swapExactTokensForTokensSupportingFeeOnTransferTokens(
        ...
        ILynexRouter.Route[] calldata routes,
    ...
    function swapExactTokensForTokensSupportingFeeOnTransferTokensCrossChain(
        uint amountIn, uint amountOutMin, ILynexRouter.Route[] calldata routes, // args for dex
    ...
    function swapExactETHForTokensSupportingFeeOnTransferTokensCrossChain(
        uint amountOutMin, ILynexRouter.Route[] calldata routes, uint netFee, // args for dex
        uint32 destinationDomain, bytes32 recipient, bytes calldata callData // args for bridge
    ) external payable {
    ...
    function _swapExactTokensForTokensSupportingFeeOnTransferTokens(
        uint amountIn, uint amountOutMin,
        ILynexRouter.Route[] calldata routes, uint256 balanceBefore,
        ...
        ILynexRouter(router).swapExactTokensForTokensSupportingFeeOnTransferTokens(
