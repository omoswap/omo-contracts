...
contract OMOBaseAerodromeAggregator is Ownable {
    ...
    function swapExactTokensForTokens(
        ...
        uint256 amountOutCharged = _swapExactTokensForTokens(
    ...
    function swapExactTokensForTokensCrossChain(
        ...
        uint bridgeAmount = _swapExactTokensForTokens(
    ...
    function _swapExactETHForTokens(
        ...
        return _swapExactTokensForTokens(amountIn, amountOutMin, routes, true, false, logReceiver);
    }
