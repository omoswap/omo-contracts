...
import "../interfaces/IBlasterswapV3SwapRouter.sol";
import "@openzeppelin/contracts/token/ERC20/IERC20.sol";
import "@openzeppelin/contracts/token/ERC20/utils/SafeERC20.sol";

contract OMOBlastBlasterswapV3Aggregator is Ownable {
    ...
    address public router = 0x9201Ae24816d1c981319f79B8122652fd519A414;
    ...
    function exactInput(
        IBlasterswapV3SwapRouter.ExactInputParams memory params,
        bool unwrapETH
    ) external payable {
    ...
    function exactInputCrossChain(
        IBlasterswapV3SwapRouter.ExactInputParams calldata params,
    ...
    function _swap(
        ...
        IBlasterswapV3SwapRouter(router).exactInput(params);
