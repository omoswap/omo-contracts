...
import "../interfaces/IThursterV3SwapRouter.sol";
import "@openzeppelin/contracts/token/ERC20/IERC20.sol";
import "@openzeppelin/contracts/token/ERC20/utils/SafeERC20.sol";

contract OMOBlastThursterV3Aggregator is Ownable {
    ...
    address public router = 0x337827814155ECBf24D20231fCA4444F530C0555;
    ...
    function exactInput(
        IThursterV3SwapRouter.ExactInputParams memory params,
        bool unwrapETH
    ) external payable {
    ...
    function exactInputCrossChain(
        IThursterV3SwapRouter.ExactInputParams calldata params,
    ...
    function _swap(
        ...
        IThursterV3SwapRouter(router).exactInput(params);
